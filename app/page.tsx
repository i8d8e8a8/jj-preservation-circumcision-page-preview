...
const designs = [
  {
    ...
    summary:
      "봉합선을 귀두 가까이에 두고, 발기 시 필요한 피부 여유는 충분히 남기는 형태입니다. 흉터가 비교적 안쪽에 자리하면서도 평상시에는 자연스러운 주름이 남습니다.",
    details: [
      {
        label: "절개선 위치",
      ...
      {
        label: "피부 여유",
        value: "피부에 적절한 여유를 남겨 발기 시 당김과 불편의 부담을 줄이는 방향으로 설계합니다.",
      },
      {
        label: "균형과 노출",
        value: "내측 피부는 짧게 정리해 귀두가 다시 덮일 가능성을 낮추면서 자연스러운 움직임은 유지합니다.",
      },
    ],
    noteTitle: "가장 권장하는 이유",
    note: "귀두 노출, 낮은 흉터 위치, 발기 시 피부 여유를 균형 있게 고려할 수 있어 본원에서 가장 권장하는 디자인입니다.",
    tone: "soft",
    recommended: true,
  },
  {
    code: "L · T",
    title: "Low & Tight",
    label: "낮은 절개선 · 여유가 적은 디자인",
    image: "circum-type-low-tight-v4.webp",
    summary:
      "봉합선은 귀두 가까이에 있지만 피부 여유와 주름을 적게 남기는 형태입니다. 평상시에는 매끈해 보일 수 있으나 발기 시 피부 당김이 나타날 가능성을 함께 고려해야 합니다.",
    details: [
      {
        label: "절개선 위치",
      ...
      {
        label: "피부 여유",
        value: "남기는 피부가 적어 평상시 주름은 줄지만, 발기 시 팽팽함과 당김이 생길 수 있습니다.",
      },
      {
        label: "주의할 특징",
        value: "국내에서 흔히 볼 수 있는 형태지만 절제량이 많아지면 불편이 커질 수 있어 사전 측정이 중요합니다.",
      },
    ],
    noteTitle: "우선 확인해야 할 단점",
    note: "발기 시 길이와 피부 탄력을 충분히 반영하지 않으면 당김이나 불편감이 지속될 수 있어 피부를 과도하게 팽팽하게 맞추지 않아야 합니다.",
    tone: "tight",
    recommended: false,
  },
  {
    ...
    details: [
      ...
      {
        label: "주의할 특징",
        value: "내측 피부와 전체 피부가 많이 남아 평상시 귀두가 살짝 덮이는 결과가 나타날 가능성이 있습니다.",
      },
    ],
    noteTitle: "우선 확인해야 할 단점",
  ...
  },
  {
    ...
    details: [
      ...
      {
        label: "피부 여유",
        value: "피부를 팽팽하게 맞추므로 평상시 주름은 적지만 발기 시 필요한 여유가 부족할 수 있습니다.",
      },
      {
        label: "주의할 특징",
        value: "중간 부위의 흉터가 눈에 띌 수 있고, 과도한 절제 시 당김과 불편이 더 분명하게 나타날 수 있습니다.",
      },
    ],
    noteTitle: "우선 확인해야 할 단점",
              ...
              >
                ...
                <div className="design-content">
                  ...
                  <div className="design-note">
                    <strong>{design.noteTitle}</strong>
                    <p>{design.note}</p>
                  </div>
                </div>
              </article>
      ...
      <section className="section doctor-section">
        <div className="shell doctor-grid">
          <div className="doctor-photo">
            <Image
              src={`${ASSET_BASE}/doctor-philosophy-surgery-v14-bw-or.png`}
